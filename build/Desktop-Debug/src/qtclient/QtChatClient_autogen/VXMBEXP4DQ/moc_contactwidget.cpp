...
void ContactWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->chatRequested((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 1: _t->groupChatRequested((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ContactWidget::*)(int )>(_a, &ContactWidget::chatRequested, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (ContactWidget::*)(int )>(_a, &ContactWidget::groupChatRequested, 1))
            return;
    }
}
...
// SIGNAL 0
void ContactWidget::chatRequested(int _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void ContactWidget::groupChatRequested(int _t1)
{
