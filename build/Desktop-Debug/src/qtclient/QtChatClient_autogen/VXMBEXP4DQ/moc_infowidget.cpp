...
#include "../../../../../../include/qtclient/infowidget.hpp"
...
void InfoWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->logoutRequest(); break;
        case 4: _t->onAddFriendClicked(); break;
        case 5: _t->onCreateGroupClicked(); break;
        case 6: _t->onAddGroupClicked(); break;
        case 7: _t->onLogoutClicked(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (InfoWidget::*)(int )>(_a, &InfoWidget::addFriendRequest, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (InfoWidget::*)(const string & , const string & )>(_a, &InfoWidget::createGroupRequest, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (InfoWidget::*)(int )>(_a, &InfoWidget::addGroupRequest, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (InfoWidget::*)()>(_a, &InfoWidget::logoutRequest, 3))
            return;
    }
}
...
// SIGNAL 0
void InfoWidget::addFriendRequest(int _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void InfoWidget::createGroupRequest(const string & _t1, const string & _t2)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 1, nullptr, _t1, _t2);
}

// SIGNAL 2
void InfoWidget::addGroupRequest(int _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 2, nullptr, _t1);
}

// SIGNAL 3
void InfoWidget::logoutRequest()
{
