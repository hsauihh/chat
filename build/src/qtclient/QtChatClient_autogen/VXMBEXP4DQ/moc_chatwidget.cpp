...
void ChatWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->unreadMessageStored((*reinterpret_cast<std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<bool>>(_a[2]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        if (QtMocHelpers::indexOfMethod<void (ChatWidget::*)(int , const string & )>(_a, &ChatWidget::sendGroupChat, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (ChatWidget::*)(int , bool )>(_a, &ChatWidget::unreadMessageStored, 2))
            return;
    }
}
...
// SIGNAL 2
void ChatWidget::unreadMessageStored(int _t1, bool _t2)
{
