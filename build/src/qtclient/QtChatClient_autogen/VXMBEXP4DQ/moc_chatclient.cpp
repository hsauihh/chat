...
#include "../../../../../include/qtclient/chatclient.hpp"
...
template <> constexpr inline auto ChatClient::qt_create_metaobjectdata<qt_meta_tag_ZN10ChatClientE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(json)>(4, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 5, 6 },
        }}),
...
void ChatClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->messageReceived((*reinterpret_cast<std::add_pointer_t<json>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        if (QtMocHelpers::indexOfMethod<void (ChatClient::*)()>(_a, &ChatClient::disconnected, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (ChatClient::*)(json )>(_a, &ChatClient::messageReceived, 2))
            return;
...
// SIGNAL 2
void ChatClient::messageReceived(json _t1)
{
