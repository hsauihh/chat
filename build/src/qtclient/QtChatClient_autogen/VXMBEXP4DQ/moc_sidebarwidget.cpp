/****************************************************************************
** Meta object code from reading C++ file 'sidebarwidget.hpp'
**
...
#include "../../../../../include/qtclient/sidebarwidget.hpp"
...
#error "The header file 'sidebarwidget.hpp' doesn't include <QObject>."
...
template <> constexpr inline auto SidebarWidget::qt_create_metaobjectdata<qt_meta_tag_ZN13SidebarWidgetE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'chatNavClicked'
        QtMocHelpers::SignalData<void()>(1, 2, QMC::AccessPublic, QMetaType::Void),
        // Signal 'contactsNavClicked'
...
void SidebarWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->chatNavClicked(); break;
        case 1: _t->contactsNavClicked(); break;
        case 2: _t->logoutRequest(); break;
        case 3: _t->clearHistoryRequest(); break;
        case 4: _t->onAvatarClicked(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (SidebarWidget::*)()>(_a, &SidebarWidget::chatNavClicked, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (SidebarWidget::*)()>(_a, &SidebarWidget::contactsNavClicked, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (SidebarWidget::*)()>(_a, &SidebarWidget::logoutRequest, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (SidebarWidget::*)()>(_a, &SidebarWidget::clearHistoryRequest, 3))
            return;
    }
}
...
// SIGNAL 0
void SidebarWidget::chatNavClicked()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void SidebarWidget::contactsNavClicked()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void SidebarWidget::logoutRequest()
{
    QMetaObject::activate(this, &staticMetaObject, 2, nullptr);
}

// SIGNAL 3
void SidebarWidget::clearHistoryRequest()
{
